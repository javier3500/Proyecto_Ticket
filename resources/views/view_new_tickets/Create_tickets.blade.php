...
<body>
  <div class="container mt-4">
    ...
    <form id="reporteForm" action="{{ route('new_ticket')}}" method="post" enctype="multipart/form-data" novalidate>
      @csrf
  ...
  <!-- Script para generar folio aleatorio -->
  <script>
    ...
    window.onload = function() {
     ...
     document.getElementById("reporteForm").addEventListener("submit", function(event) {
      ...
      if (!form.checkValidity()) {
        ...
        alert("Por favor, rellena todos los campos del formulario antes de enviarlo.");
      }
